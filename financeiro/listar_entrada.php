        ...
        <section class="content">
            ...
            <div class="wraper container-fluid">
                <div class="page-title"> 
                    <h3 class="title">Contas de entrada</h3> 
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <a href="entradas-pagas" class="btn btn-primary btn-rounded m-b-5">Entradas pagas</a>
                                    <a href="listar-saidas" class="btn btn-primary btn-rounded m-b-5">Saídas</a>
                                                        ...
                                                        <td>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu" role="menu">
                                                                    <li><a href="#" class="editar" data-nome="'.$row["nome"].'" data-id="'.$row["id"].'" data-valor="'.$row["valor"].'" data-data_entrada="'.$row["data_entrada"].'" data-toggle="modal" data-target="#editar">Editar</a></li>
                                                                    <li class="divider"></li>
                                                                    <li><a href="#" class="pagar" data-nome="'.$row["nome"].'" data-id="'.$row["id"].'" data-toggle="modal" data-target="#pagar">Pagar</a></li>
                                                                  <li><a href="#" class="deletar" data-nome="'.$row["nome"].'" data-id="'.$row["id"].'" data-toggle="modal" data-target="#deletar">Deletar</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>';
