                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <a href="listar-entradas" class="btn btn-primary btn-rounded m-b-5">Entradas pendentes</a>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php 
                                                $stmt = $dbh->prepare('SELECT c.id, c.nome, c.valor, c.data_entrada, c.data_vencimento, c.status, f.nome AS nomeFornecedor FROM conta AS c LEFT JOIN fornecedor AS f ON c.id_fornecedor=f.id WHERE c.tipo=0 AND c.status=0 ORDER BY c.data_vencimento ASC');
                                                $stmt->execute();
