    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-md-2">
                    <a href="orcamentos-entregues" class="bloco" style="cursor: pointer">
                        <div class="alert alert-info alert-with-icon">
                        <span data-notify="icon" id="icone_cliente" class="pe-7s-lock"></span>
                            <span>Entregues</span>
                        </div>
                    </a>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Orcamentos abertos</h4>
                    </div>
                    <div class="content table-responsive table-full-width">
                        <table class="table table-hover table-striped mdl-data-table" id="tabela_orcamentos" cellspacing="0" width="100%">
                            ...
                            <?php 
                                ...
                                $stmt = $dbh->prepare('SELECT * FROM orcamentos WHERE status="PENDENTE" ORDER BY data_entrega ASC');
                                $stmt->execute();
                                ...
                                foreach ($stmt->fetchAll(PDO::FETCH_ASSOC) as $row) {
                                    ...
                                    <tr id='.$row["id"].'>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" id="'.$row["id"].'" rel="tooltip" title="" class="btn btn-primary btn-simple btn-xs pagar-link">
